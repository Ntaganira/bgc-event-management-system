...
CREATE INDEX idx_attendance_registration ON attendances(registration_id);
CREATE INDEX idx_attendance_checked_in_at ON attendances(checked_in_at);
CREATE INDEX idx_attendance_method ON attendances(check_in_method);
CREATE INDEX idx_attendance_checked_by ON attendances(checked_in_by);
...
-- Add current_attendees column to events if not exists
